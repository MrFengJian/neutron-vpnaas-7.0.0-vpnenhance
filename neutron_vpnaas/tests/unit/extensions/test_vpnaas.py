...
class VpnaasExtensionTestCase(base.ExtensionTestCase):
    ...
    def test_vpnservice_create(self):
        ...
        res = self.api.post(_get_path('vpn/openvpn', fmt=self.fmt),
                            self.serialize(data),
                            content_type='application/%s' % self.fmt)
    ...
    def test_vpnservice_list(self):
        ...
        res = self.api.get(_get_path('vpn/openvpn', fmt=self.fmt))
    ...
    def test_vpnservice_update(self):
        ...
        res = self.api.put(_get_path('vpn/openvpn',
                                     id=vpnservice_id,
                                     fmt=self.fmt),
                           self.serialize(update_data))
    ...
    def test_vpnservice_get(self):
        ...
        res = self.api.get(_get_path('vpn/openvpn',
                                     id=vpnservice_id,
                                     fmt=self.fmt))
